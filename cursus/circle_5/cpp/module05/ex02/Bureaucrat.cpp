...
void Bureaucrat::signForm(AForm *aform)
{
    if (this->getGrade() <= aform->getSignGrade() && this->getGrade() <= aform->getExecGrade()) {
        ...
        std::cout << this->getName() << " couldn’t sign " << aform->getName() << " because bureaucrat's grade is lower than aform's grade to sign" << std::endl; 
    else if (this->getGrade() > aform->getExecGrade() && this->getGrade() <= aform->getSignGrade())
        std::cout << this->getName() << " couldn’t sign " << aform->getName() << " because bureaucrat's grade is lower than aform's grade to execute" << std::endl; 
    else
